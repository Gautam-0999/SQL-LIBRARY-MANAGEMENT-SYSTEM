...
![Library_project](https://github.com/Gautam-0999/SQL-LIBRARY-MANAGEMENT-SYSTEM/blob/main/LIBRARY%20IMAGE.jpg?raw=true)
...
### 1. Database Setup
![ERD](https://github.com/Gautam-0999/SQL-LIBRARY-MANAGEMENT-SYSTEM/blob/main/library_erd.png?raw=true)
...
1. **Clone the Repository**: Clone this repository to your local machine.
   ```sh
   git clone https://github.com/Gautam-0999/SQL-LIBRARY-MANAGEMENT-SYSTEM.git
   ```
